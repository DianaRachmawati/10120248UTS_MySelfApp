...
public class ProfilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnIg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = Uri.parse("http://instagram.com/_u/dianaarachmawati");
                ...
                try {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("http://instagram.com/dianaarachmawati")));
                }
            }
        });
        ...
        btnEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.btn_email) {
                    ...
                    intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"dianarachmawati272@gmail.com"});
                    intent.putExtra(Intent.EXTRA_SUBJECT, "Email dari MySelf Apps");
                    intent.putExtra(Intent.EXTRA_TEXT, "Hai, silahkan kirim email kepada Diana!");
        ...
        map_btn.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/2JqByJjh7HbRQd6w7"));
                startActivity(browserIntent);
            }
        });
    ...
    private void showSuccesDialog(){
        ...
        ((TextView) view.findViewById(R.id.textMessage)).setText("App Version 1.0.0 Diana Apps ");
